...
# First Row
    ...
    $script "transparent sap-talk-I-was"                         --startup    "52" "2337 325"
    $script "transparent sap-talk-become"                         --startup    "52" "2723 325"
    $script "transparent sap-talk-myself"                         --startup    "52" "3109 325"
    $script "transparent sap-talk-I-am"                           --startup    "52" "3495 325"      
